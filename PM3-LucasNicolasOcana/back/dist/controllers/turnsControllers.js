...
var TurnService = __importStar(require("../services/turnsServices"));
var getAppointments = function (req, res) {
    var appointments = TurnService.getAllAppointments();
    res.json(appointments);
};
exports.getAppointments = getAppointments;
var getAppointmentById = function (req, res) {
    var appointmentId = parseInt(req.params.id);
    var appointment = TurnService.getAppointmentById(appointmentId);
    if (appointment) {
...
var scheduleAppointment = function (req, res) {
    ...
    try {
        TurnService.createAppointment(date, time, userId);
        res.send("Nuevo turno agendado exitosamente");
    }
    catch (error) {
        if (error instanceof Error) {
            res.status(500).send("Error al agendar el turno: ".concat(error.message));
        }
        else {
...
var cancelAppointment = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, TurnService.cancelAppointment(id)];
            case 2:
                _a.sent();
            ...
            case 3:
                ...
                if (error_1 instanceof Error) {
                    res.status(500).send("Error al cancelar el turno: ".concat(error_1.message));
                }
                else {
